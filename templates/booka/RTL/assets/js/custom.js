...
jQuery(document).ready(function ($) {
    ...
    (function () {
        ...
        $container.imagesLoaded(function () {
            ...
            var prepareCurrency = function (value) {
                return BookaVars.currencyBefore ? BookaVars.currencySymbol + value : value + BookaVars.currencySymbol;
            };
            var $slider = $(".jqueryui-slider-container > div");
            $slider.slider({
                range: true,
                min: BookaVars.priceRange[0],
                max: BookaVars.priceRange[1],
                values: BookaVars.priceRange,
                step: BookaVars.priceStep,
    ...
    (function () {
        ...
        tour.addSteps([{
            element: "#tourStep1",
            title: "فیلتر کردن",
            content: "فیلتر کردن محصولات در بوکا خیلی جالب است!"
        }, {
            element: "#tourStep2",
            title: "دسته بندی ها",
            ...
            content: "بازه قیمت را انتخاب کنید، خواهید دید که بدون رفرش کردن صفحه، محصولات موجود در باره نمایش داده میشوند."
        }, {
            element: "#tourStep3",
            ...
            content: "برای مرتب سازی، اصلا نیازی به رفرش کردن صفحه نیست. همه ی تغییرات به صورت آنی اعمال می شوند و شما میتوانید نتیجه را ببینید!",
            placement: "bottom"
        }]);
        tour.start();
    })();
    ...
    $(".item-in-cart .fa-trash-alt").click(function () {
    ...
    $(".table-items .fa-trash-alt").click(function () {
